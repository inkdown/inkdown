      ...
      <footer className="w-full bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
        <div className="container mx-auto py-8 px-4 md:px-6 flex flex-col md:flex-row items-center justify-between">
          ...
          <nav className="flex gap-4 sm:gap-6 mt-4 md:mt-0">
            <Link to="/docs" className="text-xs text-slate-600 dark:text-slate-300 hover:underline underline-offset-4">
              Docs
            </Link>
            <Link to="/releases" className="text-xs text-slate-600 dark:text-slate-300 hover:underline underline-offset-4">
              Releases
            </Link>
